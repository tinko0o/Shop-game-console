...
exports.createOrder = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ success: false, message: "Đã xảy ra sự cố khi đặt hàng" });
  }
};
...
exports.getOrders = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "Đã xảy ra lỗi khi xuất lịch sử đơn hàng",
      });
  }
};
...
exports.getAllOrders = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "Đã xảy ra lỗi khi xuất thông tin các đơn hàng",
      });
  }
};
...
exports.confirmOrder = async (req, res) => {
  try {
    ...
    return res
      ...
      .json({
        success: false,
        message: "Dẵ xảy ra sự cố khi xác nhận đơn hàng",
      });
  }
};
...
exports.deliveryOrder = async (req, res) => {
  try {
    ...
    res
      ...
      .json({
        success: false,
        message: "Đã xảy ra sự cố khi xác nhận giao hàng",
      });
  }
};
...
exports.cancelOrderUser = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, message: "Đã xảy ra lỗi khi hủy đơn hàng" });
  }
};
